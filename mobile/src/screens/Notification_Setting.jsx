...
export default function Notification_Settings({ navigation, route }) {
    ...
    const [isEnterZone, setIsEnterZone] = useState(false);
    const [isSortZone, setIsSortZone] = useState(true);
    ...
    const handleConfirm = () => {
        dispatch(confirmNotificationSettings(userReducer.token, infos.deviceImei,
        ...
        <SafeAreaView style={styles.v1}>
            <View
                ...
                <View
                    ...
                    <Text bold style={{ fontSize: 20, color: '#FFFF' }}>{infos.vehicleName}</Text>
                    {/* <TouchableOpacity
            ...
            <View style={styles.settingPanel}>
                ...
                <View style={styles.setting}>
                    ...
                    <Switch
                        style={styles.switch}
                        thumbColor={isDetacahment ? '#18567F' : '#37474FC7'}
                        trackColor={{ false: "#ddd", true: "#aaa" }}
